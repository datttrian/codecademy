...
{"errors":\[{"detail":"Backend container expired. If you're using
Codecademy's interactive learning environment, you should be able to
solve this by refreshing your browser window. Please contact customer
